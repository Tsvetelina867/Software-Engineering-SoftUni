...
public class MergeTwoFiles {
    public static void main(String[] args) {
        String inputPath1 = "src/04. Java-Advanced-Files-and-Streams-Exercises-Resources/inputOne.txt";
        String inputPath2 = "src/04. Java-Advanced-Files-and-Streams-Exercises-Resources/inputTwo.txt";
