...
public class Judge {
    public static void main(String[] args) {
        ...
        for (Map.Entry<String, LinkedHashMap<String, Integer>> sth : contests.entrySet()) {
            for (Map.Entry<String, Integer> huh : sth.getValue().entrySet()) {
                standings.putIfAbsent(huh.getKey(), 0);
                standings.put(huh.getKey(), standings.get(huh.getKey()) + huh.getValue());
            }
        }
