package BankExamPreparation.main;
...
public class Bank {
    ...
    public void addClient(Client client){
        if (this.clients.size() == this.capacity){
            throw new IllegalArgumentException("The BankUnitTesting.bank has no capacity for more clients!");
        }
    ...
    public String statistics(){
        ...
        return String.format("The client %s is at the %s BankUnitTesting.bank!", names, this.name);
    }
